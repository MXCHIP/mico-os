...
OSStatus mico_bt_smartbridge_gatt_write_characteristic_descriptor( const mico_bt_smartbridge_socket_t* socket, const mico_bt_smart_attribute_t* descriptor )
{
    ...
    return smartbridge_bt_interface_write_characteristic_descriptor( socket->connection_handle, (mico_bt_smart_attribute_t*)descriptor );
}
...
OSStatus mico_bt_smartbridge_gatt_write_long_characteristic_descriptor( const mico_bt_smartbridge_socket_t* socket, const mico_bt_smart_attribute_t* descriptor )
{
    ...
    return smartbridge_bt_interface_write_long_characteristic_descriptor( socket->connection_handle, (mico_bt_smart_attribute_t*)descriptor );
}
...
OSStatus mico_bt_smartbridge_gatt_write_characteristic_value_without_response( const mico_bt_smartbridge_socket_t* socket, const mico_bt_smart_attribute_t* characteristic_value )
{
...
OSStatus mico_bt_smartbridge_gatt_signed_write_characteristic_value_without_response( const mico_bt_smartbridge_socket_t* socket, const mico_bt_smart_attribute_t* characteristic_value )
{
    UNUSED_PARAMETER( socket );
    UNUSED_PARAMETER( characteristic_value );
    return MICO_BT_UNSUPPORTED;
...
OSStatus mico_bt_smartbridge_gatt_write_characteristic_value( const mico_bt_smartbridge_socket_t* socket, const mico_bt_smart_attribute_t* characteristic_value )
{
    ...
    return smartbridge_bt_interface_write_characteristic_value( socket->connection_handle, (mico_bt_smart_attribute_t*)characteristic_value );
}
...
OSStatus mico_bt_smartbridge_gatt_write_long_characteristic_value( const mico_bt_smartbridge_socket_t* socket, const mico_bt_smart_attribute_t* characteristic_value )
{
    ...
    return smartbridge_bt_interface_write_long_characteristic_value( socket->connection_handle, (mico_bt_smart_attribute_t*)characteristic_value );
}

OSStatus mico_bt_smartbridge_gatt_reliable_write_characteristic_value( const mico_bt_smartbridge_socket_t* socket, const mico_bt_smart_attribute_t* characteristic_value )
{
    UNUSED_PARAMETER( socket );
    UNUSED_PARAMETER( characteristic_value );    
    return MICO_BT_UNSUPPORTED;
