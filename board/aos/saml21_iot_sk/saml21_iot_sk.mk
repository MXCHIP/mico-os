...
$(NAME)_COMPONENTS := aos/saml21_iot_sk/IOT_AT3080_drv
...
CONFIG_SYSINFO_DEVICE_NAME := saml21_iot_sk
...
GLOBAL_DEFINES += SYSINFO_MCU=\"$(HOST_MCU_FAMILY)\"
GLOBAL_DEFINES += SYSINFO_BOARD=\"$(MODULE)\"

EXTRA_TARGET_MAKEFILES +=  $(MICO_OS_PATH)/board/aos/saml21_iot_sk/saml21_download.mk
