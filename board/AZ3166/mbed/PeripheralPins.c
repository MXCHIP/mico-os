...
//*** QSPI TODO add all according to ST datasheet ***

const PinMap PinMap_QSPI_D0[] = {
    {QSPI_D0, QSPI_0, STM_PIN_DATA(STM_MODE_AF_PP, GPIO_NOPULL, GPIO_AF10_QSPI)},
    {NC,      NC,   0}
};

const PinMap PinMap_QSPI_D1[] = {
    {QSPI_D1, QSPI_0, STM_PIN_DATA(STM_MODE_AF_PP, GPIO_NOPULL, GPIO_AF10_QSPI)},
    {NC,      NC,   0}
};

const PinMap PinMap_QSPI_D2[] = {
    {QSPI_D2, QSPI_0, STM_PIN_DATA(STM_MODE_AF_PP, GPIO_NOPULL, GPIO_AF10_QSPI)},
    {NC,      NC,   0}
};

const PinMap PinMap_QSPI_D3[] = {
    {QSPI_D3, QSPI_0, STM_PIN_DATA(STM_MODE_AF_PP, GPIO_NOPULL, GPIO_AF10_QSPI)},
    {NC,      NC,   0}
};

const PinMap PinMap_QSPI_CLK[] = {
    {QSPI_CLK, QSPI_0, STM_PIN_DATA(STM_MODE_AF_PP, GPIO_NOPULL, GPIO_AF9_QSPI)},
    {NC,      NC,    0}
};

const PinMap PinMap_QSPI_CS[] = {
    {QSPI_CS, QSPI_0, STM_PIN_DATA(STM_MODE_AF_PP, GPIO_PULLUP, GPIO_AF9_QSPI)},
    {NC,      NC,   0}
};

//*** SDIO TODO add all according to ST datasheet ***

const PinMap PinMap_SDIO_CLK[] = {
    {SDIO_CLK, SDIO_0, STM_PIN_DATA(STM_MODE_AF_PP, GPIO_PULLUP, GPIO_AF12_SDIO)},
    {NC,      NC,    0}
};

const PinMap PinMap_SDIO_CMD[] = {
    {SDIO_CMD, SDIO_0, STM_PIN_DATA(STM_MODE_AF_PP, GPIO_PULLUP, GPIO_AF12_SDIO)},
    {NC,      NC,   0}
};


const PinMap PinMap_SDIO_D0[] = {
    {SDIO_D0, SDIO_0, STM_PIN_DATA(STM_MODE_AF_PP, GPIO_PULLUP, GPIO_AF12_SDIO)},
    {NC,      NC,   0}
};

const PinMap PinMap_SDIO_D1[] = {
    {SDIO_D1, SDIO_0, STM_PIN_DATA(STM_MODE_AF_PP, GPIO_PULLUP, GPIO_AF12_SDIO)},
    {NC,      NC,   0}
};

const PinMap PinMap_SDIO_D2[] = {
    {SDIO_D2, SDIO_0, STM_PIN_DATA(STM_MODE_AF_PP, GPIO_PULLUP, GPIO_AF12_SDIO)},
    {NC,      NC,   0}
};

const PinMap PinMap_SDIO_D3[] = {
    {SDIO_D3, SDIO_0, STM_PIN_DATA(STM_MODE_AF_PP, GPIO_PULLUP, GPIO_AF12_SDIO)},
    {NC,      NC,   0}
};
