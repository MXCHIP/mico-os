                             ...
                             uint16_t wStatusLength)
{
    ...
    case MGC_SCSI_STATE_STOP_UNIT:
        MUSB_PRT("MGC_SCSI_STATE_STOP_UNIT\r\n");
        /* done */
        return 0;
