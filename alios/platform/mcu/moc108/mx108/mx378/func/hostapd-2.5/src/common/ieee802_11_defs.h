...
STRUCT_PACKED struct ieee80211_hdr {
	le16 frame_control;
	le16 duration_id;
	u8 addr1[6];
	u8 addr2[6];
...
#define VARIABLE_ARRAY_SPARE                   1

STRUCT_PACKED struct ieee80211_mgmt {
	le16 frame_control;
	le16 duration;
	u8 da[6];
	u8 sa[6];
		...
		STRUCT_PACKED struct {
			...
			STRUCT_PACKED union {
				...
				STRUCT_PACKED struct {
					...
					le16 status_code;
					u8 variable[1];
				}GCC_PACKED ft_action_resp;
				
				STRUCT_PACKED struct {
					u8 action;
					u8 trans_id[WLAN_SA_QUERY_TR_ID_LEN];
				}GCC_PACKED sa_query_req;
				
				STRUCT_PACKED struct {
					u8 action; /* */
					u8 trans_id[WLAN_SA_QUERY_TR_ID_LEN];
				}GCC_PACKED sa_query_resp;
				
				STRUCT_PACKED struct {
					u8 action;
					u8 dialogtoken;
					u8 variable[1];
				}GCC_PACKED wnm_sleep_req;
				...
				STRUCT_PACKED struct {
					...
					le16 keydata_len;
					u8 variable[1];
				}GCC_PACKED wnm_sleep_resp;
				
				STRUCT_PACKED struct {
					u8 action;
					u8 variable[1];
				}GCC_PACKED public_action;
				...
				STRUCT_PACKED struct {
					 ...
					 * Entries (optional) */
					u8 variable[1];
				}GCC_PACKED bss_tm_query;
				
				STRUCT_PACKED struct {
					u8 action; /* 15 */
					u8 variable[1];
				}GCC_PACKED slf_prot_action;
				
				STRUCT_PACKED struct {
					u8 action;
					u8 variable[1];
				}GCC_PACKED fst_action;
			}GCC_PACKED u;
...
STRUCT_PACKED struct ieee80211_ht_capabilities {
...
STRUCT_PACKED struct ieee80211_ht_operation {
	u8 primary_chan;
...
STRUCT_PACKED struct ieee80211_vht_capabilities {
	...
	STRUCT_PACKED struct {
		...
		le16 tx_map;
		le16 tx_highest;
	}GCC_PACKED vht_supported_mcs_set;
}GCC_PACKED;

STRUCT_PACKED struct ieee80211_vht_operation {
...
STRUCT_PACKED struct ieee80211_ampe_ie {
...
STRUCT_PACKED struct wmm_ac_parameter {
 ...
 * Response frmaes)
 */
STRUCT_PACKED struct wmm_parameter_element {
...
/* WMM TSPEC Element */
STRUCT_PACKED struct wmm_tspec_element {
	u8 eid; /* 221 = 0xdd */
	u8 length; /* 6 + 55 = 61 */
	u8 oui[3]; /* 00:50:f2 */
	u8 oui_type; /* 2 */
...
STRUCT_PACKED struct p2ps_feature_capab {
	u8 cpt;
	u8 reserved;
}GCC_PACKED;
...
STRUCT_PACKED struct ieee80211_2040_bss_coex_ie {
	u8 element_id;
	u8 length;
	u8 coex_param;
}GCC_PACKED;

STRUCT_PACKED struct ieee80211_2040_intol_chan_report {
	u8 element_id;
	u8 length;
	u8 op_class;
...
STRUCT_PACKED struct wnm_sleep_element {
...
STRUCT_PACKED struct tpc_report {
	u8 eid;
	u8 len;
	u8 tx_power;
	u8 link_margin;
...
STRUCT_PACKED struct rrm_link_measurement_request {
	u8 dialog_token;
	s8 tx_power;
	s8 max_tp;
	u8 variable[];
...
STRUCT_PACKED struct rrm_link_measurement_report {
	u8 dialog_token;
...
STRUCT_PACKED struct multi_band_ie {
