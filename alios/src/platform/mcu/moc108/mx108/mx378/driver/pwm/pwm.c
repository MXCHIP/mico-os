...
static void (*p_PWM_Int_Handler[CHANNEL_NO])(UINT8);

static void pwm_gpio_configuration(UINT8 chan)
{
    UINT32 ret;
    UINT32 param;
...
static void pwm_icu_configuration(pwm_param_t *pwm_param)
{
    UINT32 ret;
    UINT32 prm;
...
static void init_pwm_param(pwm_param_t *pwm_param)
{
    ...
    pwm_gpio_configuration(pwm_param->channel);
