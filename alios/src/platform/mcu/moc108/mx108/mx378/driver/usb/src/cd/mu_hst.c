...
static uint16_t MGC_SkipEntry(const uint8_t *, uint16_t , uint16_t );
...
static void MGC_HostSetDeviceAddress(void *pParam)
{
    ...
    MUSB_PRT("MGC_HostSetDeviceAddress\r\n");
    ...
    if(ret)
    {
        MUSB_PRT("MGC_HostSetDeviceAddress_failed\r\n");
    }
}
...
void MGC_HostGetShortDescriptorZeroAddress(void *pParam)
{
    ...
    MUSB_PRT("MGC_HostGetShortDescriptorZeroAddress\r\n");
...
static void MGC_HostGetShortDescriptor(void *pParam)
{
    ...
    MUSB_PRT("MGC_HostGetShortDescriptor\r\n");
...
static void MGC_HostGetFullDescriptor(void *pParam)
{
    ...
    MUSB_PRT("MGC_HostGetFullDescriptor\r\n");
