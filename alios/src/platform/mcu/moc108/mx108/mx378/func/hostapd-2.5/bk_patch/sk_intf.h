...
extern int ke_mgmt_peek_rxed_next_payload_size(void);
...
extern int ke_data_peek_txed_next_payload_size(void);
extern int ke_data_peek_rxed_next_payload_size(void);
extern int ws_mgmt_peek_rxed_next_payload_size(void);
extern int ws_get_mgmt_packet(unsigned char *buf, int len, int flag);
extern int ws_data_peek_rxed_next_payload_size(void);
extern int ws_get_data_packet(unsigned char *buf, int len, int flag);
extern SOCKET mgmt_get_socket_num(void);
extern SOCKET data_get_socket_num(void);
extern SOCKET ioctl_get_socket_num(void);
#endif
// eof
