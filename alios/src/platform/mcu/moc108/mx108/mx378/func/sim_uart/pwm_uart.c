...
__INT_HANDLER__ void UARTCALL uart_io_sim_timer_int_handle_tx_data(unsigned char ucChannel)
{
...
__INT_HANDLER__ void UARTCALL uart_io_sim_timer_int_handle_rx_data(unsigned char ucChannel)
{
    ...
    if (uart_io_sim_rx_buf_current_bit < 8)             // data bit
    {
        ...
        if(uart_io_sim_rx_buf_current_bit == 8)
            ...
            *((volatile UINT32 *)(PWM_CTL)) = (*(volatile UINT32 *)(PWM_CTL))| (2 << (UART_IO_SIM_PWM_CAP_NEG_RX_CHN* 4));
            ...
            kfifo_put(uart.rx, (UINT8 *)&(uart_io_sim_rx_buf[uart_io_sim_rx_buf_current_cnt]), 1);  //get char c
...
__INT_HANDLER__ void UARTCALL uart_io_sim_int_handle_rx_cap_neg(unsigned char ucChannel)
{   
