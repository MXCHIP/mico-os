...
def sflasher(argv):
    ...
    -f mico-os/makefiles/OpenOCD/moc109/moc109.cfg \
    -f mico-os/makefiles/OpenOCD/moc109/flash.tcl \
    -c init -c jtagmode -c "writefile %s %s" -c shutdown 2>build/openocd.log'%(args.openocd, args.file, args.addr)
