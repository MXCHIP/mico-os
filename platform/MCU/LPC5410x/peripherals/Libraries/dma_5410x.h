...
/* On LPC5410X, Max DMA channel is 22 */
...
/** @defgroup DMA_COMMON_5410X CHIP: LPC5410X DMA Controller driver common functions
 * @{
 */
...
/** @defgroup DMA_COMMON_5410X CHIP: LPC5410X DMA Controller driver common channel functions
 * @{
 */
