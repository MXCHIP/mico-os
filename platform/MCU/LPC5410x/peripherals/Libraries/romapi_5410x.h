...
/* v2 ROM driver APIs */
// Magicoe removed #include "romapi_adc.h"
// Magicoe removed #include "romapi_dma.h"
// Magicoe removed #include "romapi_i2cm.h"
// Magicoe removed #include "romapi_i2cmon.h"
// Magicoe removed #include "romapi_i2cs.h"
// Magicoe removed #include "romapi_spim.h"
// Magicoe removed #include "romapi_spis.h"
// Magicoe removed #include "romapi_uart.h"
...
// Magicoe	const ROM_I2CMD_API_T *pI2CMD;				/*!< v2 I2C master only driver API function table base address */
// Magicoe	const ROM_I2CSD_API_T *pI2CSD;				/*!< v2 I2C slave only driver API function table base address */
// Magicoe	const ROM_I2CMOND_API_T *pI2CMOND;			/*!< v2 I2C bus monitor driver API function table base address */
// Magicoe	const ROM_SPIMD_API_T *pSPIMD;				/*!< v2 SPI master only driver API function table base address */
// Magicoe	const ROM_SPISD_API_T *pSPISD;				/*!< v2 SPI slave only driver API function table base address */
// Magicoe	const ROM_DMAALTD_API_T *pDMAALT;			/*!< v2 abstract DMA driver API function table base address */
// Magicoe	const ROM_ADC_API_T *pADCALT;				/*!< v2 ADC driver API function table base address */
// Magicoe	const ROM_UART_API_T *pUARTALT;				/*!< v2 UART driver API function table base address */
} LPC_ROM_API_T;
