 ...
 * @param	vd1LpLevel			: VD1 level in low power mode
 * @param	vd2LpLevel			: VD2 level in low power mode
 * @param	vd3LpLevel			: VD3 level in low power mode
 * @param	vd8LpLevel			: VD8 level in low power mode
 * @param	flevel				: Fine voltage level in low power mode
 * @param	vd1_lp_full_poweren	: Enable LP VD1 in High current mode
 * @param	vd2_lp_full_poweren	: Enable LP VD2 in High current mode
 * @param	vd3_lp_full_poweren	: Enable LP VD3 in High current mode
 * @param	vd8_lp_full_poweren	: Enable LP VD8 in High current mode
 * @return	Nothing
 */
void Chip_POWER_SetLPVDLevel(POWER_LPVOLTAGELEVEL_T vd1LpLevel,
							 POWER_LPVOLTAGELEVEL_T vd2LpLevel,
							 POWER_LPVOLTAGELEVEL_T vd3LpLevel,
							 POWER_LPVOLTAGELEVEL_T vd8LpLevel,
							 POWER_LPFINEVOLTAGELEVEL_T flevel,
							 bool vd1_lp_full_poweren,
							 bool vd2_lp_full_poweren,
							 bool vd3_lp_full_poweren,
							 bool vd8_lp_full_poweren);
