...
#include "app_msg.h"
#include "timer_api.h"
//#include "three_d_ti.h"	
//#include "vb_nld_iir_fixed.h"
#include "rtc.h"
...
//****************************************************************************************
	...
	#if (defined(FUNC_RECORD_EN) && (defined(FUNC_USB_EN) || defined(FUNC_CARD_EN)))   			//录音功能
...
//		#define BT_HW_POWER_ON_OFF								// BT硬件开关
...
//		#define AUTO_MV_BT_TEST_FUNC 							// auto scan and test bt device, 
		...
		#if defined(FAST_POWER_ON_OFF_BT) && defined(BT_HW_POWER_ON_OFF)
			#error	"Cannot define FAST_POWER_ON_OFF_BT and BT_HW_POWER_ON_OFF at the same time"
		#endif
	#endif
//****************************************************************************************
//                 UART DEBUG功能配置        
...
//****************************************************************************************
	...
	//0x6000 represents 0.75 for cross_gain.
	//0x8000 represents 0 db for post_gain.
	#define FUNC_AUDIO_3D_EFFECT_EN		
		#define AUDIO_3D_EFFECT_POST_VAL          0x8000    // 3D post gain: 0 db 取值范围{ 0db: 32768, 
                                                            //                              1db: 32766, 2db: 41252,  3db: 46286,  4db: 51933,  5db: 58270,  6db: 65380,
                                                            //                             -1db: 29204,-2db: 26028, -3db: 23197, -4db: 20675, -5db: 18426, -6db:16422}                           
        #define AUDIO_3D_EFFECT_INTENSITY         63        // 取值范围：{0, 6, 13, 19, 25, 31, 38, 44, 50, 56, 63, 69, 75, 81, 88, 94}%
        #define AUDIO_3D_EFFECT_ALC_EN            1         //1:使能3D ALC, 0：禁能3D ALC
        
//****************************************************************************************
//                 虚拟低音音效功能配置        
//****************************************************************************************
    #define FUNC_AUDIO_VB_EFFECT_EN
        #define AUDIO_VB_FREQ_CUTOFF        100  
        #define AUDIO_VB_LFC_PREAMP         0           //VB lfc_preamp: 0: 0db, 6:6db, Valid values: 0 ~ 6 dB
