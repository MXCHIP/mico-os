 ...
 * @param  Mode 0--Normal mode, 1--USB mode
 * @return NONE
 */
 ...
 * @return NONE
 */
void I2sClassdSampleRateSet(uint32_t SampleRate, uint8_t ClassDSel);
 ...
 * @return NONE
 */
void I2sClassdSTASampleRateSet(uint32_t SampleRate, bool ReSample);

/**
 * @brief  support extern classD,it works in i2s slave mode
 * @param  SrcDatFrom 1 = i2s pcm data from adc, 0 = i2s pcm data from phub
 * @param  I2sFormat right/left/i2s/dsp
 * @return NONE
 */
...
/**
 * @brief  support extern classD,it works in i2s master mode
 * @param  SrcDatFrom 1 = i2s pcm data from adc, 0 = i2s pcm data from phub
 * @param  I2sFormat right/left/i2s/dsp
 * @return NONE
 */
