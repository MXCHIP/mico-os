...
#define OS_PRIO_0     (configMAX_PRIORITIES-1)	 /** High **/
#define OS_PRIO_1     (configMAX_PRIORITIES-2)
#define OS_PRIO_2     (configMAX_PRIORITIES-3)
#define OS_PRIO_3     (configMAX_PRIORITIES-4)
#define OS_PRIO_4     0	 /** Low **/

#define WLCMGR_PRIO 5
#define WIFI_DRIVER_PRIO  6
