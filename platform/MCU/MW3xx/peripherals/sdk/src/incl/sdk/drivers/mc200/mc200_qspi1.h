/****************************************************************************//**
 * @file     mc200_qspi1.h
 * @brief    QSPI1 driver module header file.
 * @version  V1.0.0
 * @date     06-Feb-2013
...
#ifndef __MC200_QSPI1_H__
#define __MC200_QSPI1_H__
...
/** @defgroup QSPI1_Public_FunctionDeclaration
 *  @brief QSPI1 functions statement
 *  @{
 */
...
/*@} end of group QSPI1_Public_FunctionDeclaration */

/*@} end of group QSPI1 */

/*@} end of group MC200_Periph_Driver */
#endif /* __MC200_QSPI1_H__ */
