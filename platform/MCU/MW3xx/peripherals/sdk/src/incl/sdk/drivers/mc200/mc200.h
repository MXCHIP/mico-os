/****************************************************************************//**
 * @file     mc200.h
 * @brief    MC200 device header file.
 * @version  V1.0.0
 * @date     06-Feb-2013
...
#define QSPI0_BASE            ((uint32_t)0x46010000)            /*!< QSPI0 module base address */
#define SSP0_BASE             ((uint32_t)0x46020000)            /*!< SPI0 module base address */
#define SSP1_BASE             ((uint32_t)0x46030000)            /*!< SPI1 module base address */
#define UART0_BASE            ((uint32_t)0x46040000)            /*!< UART0 module base address */
#define UART1_BASE            ((uint32_t)0x46050000)            /*!< UART1 module base address */
...
#define QSPI1_BASE            ((uint32_t)0x46090000)            /*!< QSPI1 module base address */
...
#define UART3_BASE            ((uint32_t)0x48030000)            /*!< UART3 module base address */
