/****************************************************************************//**
 * @file     mc200_sdio.h
 * @brief    SDIO driver module header file.
 * @version  V1.0.0
 * @date     06-Feb-2013
...
#ifndef __MC200_SDIO_H__
#define __MC200_SDIO_H__
...
typedef enum
{
  SDIOC_INT_CMDCOMP = 0,                   /*!< Command complete interrupt */
  ...
  SDIOC_INT_ERRINT = 15,                   /*!< Error interrupt */
  ...
  SDIOC_INT_AHBTERR = 28,                  /*!< AHB Target error interrupt */
...
typedef enum
{
  SDIOC_STATUS_CCMDINHBT = 0,                  /*!< Command inhibit(CMD) status */

  SDIOC_STATUS_DCMDINHBT,                  /*!< Command inhibit(DAT) status */

  SDIOC_STATUS_DATACTV,                    /*!< DAT line active  */

  SDIOC_STATUS_WRACTV = 8,                     /*!< Write transfer active */
  ...
  SDIOC_STATUS_CINDSTD = 16,                    /*!< Card inserted */
 ...
 *  @{
 */
#define IS_SDIOC_STATUS_TYPE(STATUS_TYPE)    (((STATUS_TYPE) >= 0) && ((STATUS_TYPE) <= SDIOC_STATUS_UPRDATLVL_DAT7))
 ...
 *  @{
 */
#define IS_SDIOC_INT_TYPE(INT_TYPE)          (((INT_TYPE) >= 0) && ((INT_TYPE) <= SDIOC_INT_ALL))
