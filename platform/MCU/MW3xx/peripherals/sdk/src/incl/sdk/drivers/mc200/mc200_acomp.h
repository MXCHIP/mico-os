/****************************************************************************//**
 * @file     mc200_acomp.h
 * @brief    ACOMP driver module header file.
 * @version  V1.0.0
 * @date     06-Feb-2013
...
#ifndef __MC200_ACOMP_H__
#define __MC200_ACOMP_H__
...
typedef enum
{
  ACOMP_POS_CH_GPIO7,                         /*!< Gpio7 selection */
  ACOMP_POS_CH_GPIO6,                         /*!< Gpio6 selection */
  ACOMP_POS_CH_GPIO5,                         /*!< Gpio5 selection */
  ACOMP_POS_CH_GPIO4,                         /*!< Gpio4 selection */
  ACOMP_POS_CH_GPIO3,                         /*!< Gpio3 selection */
  ACOMP_POS_CH_GPIO2,                         /*!< Gpio2 selection */
  ACOMP_POS_CH_GPIO1,                         /*!< Gpio1 selection */
  ACOMP_POS_CH_GPIO0,                         /*!< Gpio0 selection */
...
typedef enum
{
  ACOMP_NEG_CH_GPIO7,                         /*!< Gpio7 selection */
  ACOMP_NEG_CH_GPIO6,                         /*!< Gpio6 selection */
  ACOMP_NEG_CH_GPIO5,                         /*!< Gpio5 selection */
  ACOMP_NEG_CH_GPIO4,                         /*!< Gpio4 selection */
  ACOMP_NEG_CH_GPIO3,                         /*!< Gpio3 selection */
  ACOMP_NEG_CH_GPIO2,                         /*!< Gpio2 selection */
  ACOMP_NEG_CH_GPIO1,                         /*!< Gpio1 selection */
  ACOMP_NEG_CH_GPIO0,                         /*!< Gpio0 selection */
  ...
  ACOMP_NEG_CH_VBAT_0P25,                     /*!< Vbat Scaling factor 0.25 */
  ACOMP_NEG_CH_VBAT_0P50,                     /*!< Vbat Scaling factor 0.50 */
  ACOMP_NEG_CH_VBAT_0P75,                     /*!< Vbat Scaling factor 0.75 */
  ACOMP_NEG_CH_VBAT_1P00                      /*!< Vbat Scaling factor 1.00 */
