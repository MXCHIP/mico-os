...
static inline int aes_set_dir_and_iv(const uint32_t *pIV,
			     ...
			     hw_aes_mode_t hw_mode)
{
	...
	rv = aes_set_dir_and_iv(pIV, dir, &aesConfig);
	if (rv != WM_SUCCESS)
		return rv;
