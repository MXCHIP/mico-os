...
/**
 *  @brief I2C0, I2C1 and I2C2 address array
 */
 ...
 *
 * @param[in]  intPeriph: Select the peripheral, should be INT_I2C0, INT_I2C1 or INT_I2C2
 * @param[in]  i2cNo:  Select the I2C port, should be I2C0_PORT, I2C1_PORT, I2C2_PORT.
 *
 * @return none
 *
 *******************************************************************************/
...
{
  I2C_IntHandler(INT_I2C2, I2C2_PORT);
}
